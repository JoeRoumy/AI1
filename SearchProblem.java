		...
		do {
			...
			System.out.println("Iteration number: "+currentDepth);
				...
				if(loop%50000 == 0) {
					...
					switch (strategy) {
					case "ID":	ID(expand(thisNode),currentDepth);		break;
					case "BF":	BF(expand(thisNode));		break;
					case "DF":	DF(expand(thisNode));		break;
					case "UC":	UC(expand(thisNode));		break;
					case "GR1":	GR1(expand(thisNode));		break;
					case "AS1":	AS1(expand(thisNode));		break;
					case "GR2":	GR2(expand(thisNode));		break;
					case "AS2":	AS2(expand(thisNode));		break;
